  ...
  return (
    <View style={{ flex: 1, backgroundColor: Color.tertiary }}>
      ...
      <View style={{ flexDirection: 'row', margin: 10 }}>
        ...
        <Text style={{ marginLeft: 40, color: '#000', fontWeight: 'bold', fontSize: 20, alignSelf: 'center' }}>Privacy Policy</Text>
      </View>
      <View style={{ flex: 1 }}>
        <WebView
          source={{ uri: 'https://development.smapidev.co.in/privacy_policy' }}
        // style={{ flex: 1 }}
        />
      </View>
