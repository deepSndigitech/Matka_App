  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#000' }}>
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#000' }}>
        ...
        <Image source={require('../Images/rezeetImg/matka.png')} style={{ height: 200, width: 200, resizeMode: 'contain', marginVertical: 10, }} />

        <Text style={{ fontSize: 26, fontWeight: '800', color: '#FFF', textAlign:'center'}}>Welcome To Matka game</Text>

        <TouchableOpacity style={{ marginHorizontal: 20, borderRadius: 10, padding: 5, width: '40%', backgroundColor: Color.onError, marginBottom: 20, marginTop: 50 }} onPress={() => props.navigation.navigate('Login')}>
